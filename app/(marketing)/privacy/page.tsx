...
export const metadata: Metadata = {
  title: "Privacy",
  description:
    "What Pergamum collects, why, and what we don't do. The short, readable version.",
};
      ...
      <div className="space-y-10 text-[15px] leading-[1.7] text-foreground/85">
        ...
        <Section title="What we don't do">
          <ul className="space-y-2 list-disc pl-5 marker:text-muted-foreground/60">
            ...
            <li>We don&apos;t show ads on Pergamum.</li>
          </ul>
        </Section>
        ...
        <Section title="Cookies">
          <p>
            Pergamum uses one technical cookie to keep you signed in. No tracking cookies, no third-party trackers, no fingerprinting.
          </p>
        </Section>
