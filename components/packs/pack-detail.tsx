...
import { FollowStateProvider } from "@/components/profile/follow-state";
...
import { PackRunStateProvider } from "@/components/packs/pack-run-state";
import { PackOfferSlot } from "@/components/packs/pack-offer-slot";
...
export function PackDetail({
  ...
  return (
    <FollowStateProvider initiallyFollowing={initiallyFollowing}>
      <PackRunStateProvider>
