-- ============================================================
-- Rollback for: 0029_lead_booked_visibility
-- Restores get_my_leads() and get_lead_detail() to their pre-0029
-- shapes (no booked_at). No columns were added in 0029, so nothing
-- else to restore.
--
